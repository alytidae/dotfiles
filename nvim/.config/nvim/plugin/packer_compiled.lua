...
_G.packer_plugins = {
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/igor/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["cmp-snippy"] = {
    loaded = true,
    path = "/home/igor/.local/share/nvim/site/pack/packer/start/cmp-snippy",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/igor/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-snippy"] = {
    loaded = true,
    path = "/home/igor/.local/share/nvim/site/pack/packer/start/nvim-snippy",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/igor/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
